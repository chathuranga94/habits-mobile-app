...
import { HabitsEditScreen, HabitsTrackScreen, HabitsProgressScreen, HabitsConfigureScreen, HabitsHistoryScreen } from '../index'
...
function HabitsBottomTab({ navigation, route }) {
    ...
    return (
      <BottomTab.Navigator initialRouteName={INITIAL_ROUTE_NAME}>
        <BottomTab.Screen
          name="Home"
          component={HabitsProgressScreen} // component={HabitsTodayScreen}
          options={{
            title: 'Home',
